...
Shader "Joaquin_Ivanko_Indicator"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_7_0 = (sin( mulTime5 )*0.5 + 0.5);
			float4 lerpResult19 = lerp( _ColorIndicador , color20 , temp_output_7_0);
			o.Emission = lerpResult19.rgb;
			o.Alpha = ( tex2D( _TextureSample0, i.uv_texcoord ).r * temp_output_7_0 );
		}
...
/*ASEBEGIN
Version=18900
363;73;1101;538;1226.289;926.8167;2.019895;True;False
...
Node;AmplifyShaderEditor.ColorNode;4;-387.4357,-872.4637;Inherit;False;Property;_ColorIndicador;Color Indicador;1;0;Create;True;0;0;0;False;0;False;1,0.8,0,0;1,0.8,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;3;-357.5612,-314.9701;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;5a1ef581b25a870478409ac17e72307d;5a1ef581b25a870478409ac17e72307d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;20;-400.1519,-548.7874;Inherit;False;Constant;_Color0;Color 0;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;19;-16.37185,-429.6136;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=315773834F0917289B457C8929289E2168D48062