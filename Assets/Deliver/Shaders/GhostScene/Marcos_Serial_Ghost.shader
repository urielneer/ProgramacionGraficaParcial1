...
Shader "Custom/Marcos_Serial_Ghost"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_10_0 = sin( ( ( ( 1.0 - ase_vertex3Pos.y ) + mulTime5 ) * ( _Frequency * 6.28318 ) ) );
			float4 appendResult27 = (float4(0.0 , ( _CambiaNoise * _Time.y ) , 0.0 , 0.0));
			float4 temp_output_13_0 = saturate( ( ( _GhostColor * temp_output_10_0 ) * tex2D( _Atmosphere, appendResult27.xy ) ) );
			...
			float4 temp_output_14_0 = saturate( ( ( temp_output_10_0 * pow( fresnelNode19 , _Power ) ) * tex2D( _Ghost, appendResult27.xy ) ) );
			o.Emission = ( temp_output_13_0 + temp_output_14_0 ).rgb;
...
/*ASEBEGIN
Version=18900
1920;73;1920;928;2228.364;292.2435;2.132612;False;False
Node;AmplifyShaderEditor.CommentaryNode;39;-1776.192,175.265;Inherit;False;1078.64;477.4541;Scanlines;11;8;18;7;5;4;1;2;3;6;17;10;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-1279.783,536.7192;Inherit;False;Constant;_TauManual;TauManual;3;0;Create;True;0;0;0;False;0;False;6.28318;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;17;-1003.863,354.5146;Inherit;False;FLOAT;1;0;FLOAT;0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.SamplerNode;37;-276.7542,52.4769;Inherit;True;Property;_Atmosphere;Atmosphere;5;0;Create;True;0;0;0;False;0;False;-1;c7ae4a6c8bbb694419d4dac2e11c4b86;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;35;-612.9351,1207.816;Inherit;True;Property;_Ghost;Ghost;6;0;Create;True;0;0;0;False;0;False;-1;163b47d1a73f00a4a8a590a1926e0834;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6057E55514FC683077EB026B89B8776FC790060C