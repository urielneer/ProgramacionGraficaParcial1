	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				int lerpResult14_g328 = lerp( 0 , 1 , (float)(int)IsDrunk49);
				float4 lerpResult9_g328 = lerp( ScreenRGB14 , PostDrunk16 , (float)lerpResult14_g328);
				...
				int lerpResult15_g328 = lerp( 0 , 1 , (float)(int)IsFlashBanged42);
				float4 lerpResult5_g328 = lerp( lerpResult9_g328 , PostFlashBang24 , (float)lerpResult15_g328);
				...
				int lerpResult18_g328 = lerp( 0 , 1 , (float)(int)IsDamaged48);
				float4 lerpResult4_g328 = lerp( lerpResult5_g328 , PostDamage22 , (float)lerpResult18_g328);
				...
				int lerpResult14_g325 = lerp( 0 , 1 , (float)(int)break585.r);
				float4 lerpResult9_g325 = lerp( temp_output_386_0 , temp_output_695_61 , (float)lerpResult14_g325);
				int lerpResult15_g325 = lerp( 0 , 1 , (float)(int)break585.g);
				float4 lerpResult5_g325 = lerp( lerpResult9_g325 , temp_output_695_61 , (float)lerpResult15_g325);
				int lerpResult18_g325 = lerp( 0 , 1 , (float)(int)break585.b);
				float4 lerpResult4_g325 = lerp( lerpResult5_g325 , temp_output_695_61 , (float)lerpResult18_g325);
				float4 PostHeal20 = lerpResult4_g325;
				float IsHealing52 = _IsHealing;
				int lerpResult32_g328 = lerp( 0 , 1 , (float)(int)IsHealing52);
				float4 lerpResult21_g328 = lerp( lerpResult4_g328 , PostHeal20 , (float)lerpResult32_g328);
				int lerpResult14_g326 = lerp( 0 , 1 , (float)(int)IsDrunk49);
				float4 lerpResult9_g326 = lerp( ScreenRGB14 , PostDrunk16 , (float)lerpResult14_g326);
				int lerpResult15_g326 = lerp( 0 , 1 , (float)(int)IsFlashBanged42);
				float4 lerpResult5_g326 = lerp( lerpResult9_g326 , PostFlashBang24 , (float)lerpResult15_g326);
				int lerpResult18_g326 = lerp( 0 , 1 , (float)(int)IsDamaged48);
				float4 lerpResult4_g326 = lerp( lerpResult5_g326 , PostDamage22 , (float)lerpResult18_g326);
				int lerpResult32_g326 = lerp( 0 , 1 , (float)(int)IsHealing52);
				float4 lerpResult21_g326 = lerp( lerpResult4_g326 , PostHeal20 , (float)lerpResult32_g326);
				float3 break12_g322 = float3( 0,0,0 );
				...
				int lerpResult14_g327 = lerp( 0 , 1 , (float)(int)break661.r);
				float4 lerpResult9_g327 = lerp( lerpResult21_g326 , temp_output_1019_0 , (float)lerpResult14_g327);
				int lerpResult15_g327 = lerp( 0 , 1 , (float)(int)break661.g);
				float4 lerpResult5_g327 = lerp( lerpResult9_g327 , temp_output_1019_0 , (float)lerpResult15_g327);
				int lerpResult18_g327 = lerp( 0 , 1 , (float)(int)break661.b);
				float4 lerpResult4_g327 = lerp( lerpResult5_g327 , temp_output_1019_0 , (float)lerpResult18_g327);
				float4 PostCamera27 = lerpResult4_g327;
				int lerpResult23_g328 = lerp( 0 , 1 , (float)(int)IsUsingCamera50);
				float4 lerpResult22_g328 = lerp( lerpResult21_g328 , PostCamera27 , (float)lerpResult23_g328);
				float4 temp_output_390_0 = lerpResult22_g328;
				float WU_Alpha525 = _WakeUp_Alpha;
				float4 WakeUpAction1258 = _WakeUpAction1;
				float4 break668 = WakeUpAction1258;
				int lerpResult14_g333 = lerp( 0 , 1 , (float)(int)break668.r);
				float4 lerpResult9_g333 = lerp( temp_output_390_0 , ( temp_output_390_0 * WU_Alpha525 ) , (float)lerpResult14_g333);
				int lerpResult15_g333 = lerp( 0 , 1 , (float)(int)break668.g);
				float4 lerpResult5_g333 = lerp( lerpResult9_g333 , float4( 0,0,0,0 ) , (float)lerpResult15_g333);
				float2 texCoord1_g332 = i.uv.xy * float2( 1,1 ) + float2( 0,0 );
				float pixelWidth30_g332 =  1.0f / 1000.0;
				float pixelHeight30_g332 = 1.0f / 1000.0;
				half2 pixelateduv30_g332 = half2((int)(texCoord1_g332.x / pixelWidth30_g332) * pixelWidth30_g332, (int)(texCoord1_g332.y / pixelHeight30_g332) * pixelHeight30_g332);
				float2 lerpResult32_g332 = lerp( texCoord1_g332 , pixelateduv30_g332 , (float)0);
				float2 break5_g332 = ( lerpResult32_g332 - float2( 0.5,0.5 ) );
				float2 WU_EyeSize965 = _WakeUp_EyeSize;
				float2 break11_g331 = WU_EyeSize965;
				float WU_Time984 = _WakeUp_Time;
				float mulTime15_g331 = _Time.y * WU_Time984;
				float temp_output_17_0_g331 = (0.0 + (sin( mulTime15_g331 ) - -1.0) * (break11_g331.y - 0.0) / (1.0 - -1.0));
				float2 appendResult10_g331 = (float2(break11_g331.x , temp_output_17_0_g331));
				float2 break28_g332 = appendResult10_g331;
				float2 appendResult10_g332 = (float2(( ( break5_g332.x / _ScreenParams.y ) * break28_g332.x ) , ( ( break5_g332.y / _ScreenParams.x ) * break28_g332.y )));
				float WU_EyeRadius963 = _WakeUp_EyeRadius;
				float temp_output_16_0_g332 = ( 1.0 - distance( ( appendResult10_g332 * WU_EyeRadius963 ) , float2( 0,0 ) ) );
				float4 appendResult24_g332 = (float4(temp_output_16_0_g332 , temp_output_16_0_g332 , temp_output_16_0_g332 , temp_output_16_0_g332));
				int lerpResult18_g333 = lerp( 0 , 1 , (float)(int)break668.b);
				float4 lerpResult4_g333 = lerp( lerpResult5_g333 , ( temp_output_390_0 * appendResult24_g332 ) , (float)lerpResult18_g333);
				float2 texCoord1_g330 = i.uv.xy * float2( 1,1 ) + float2( 0,0 );
				float pixelWidth30_g330 =  1.0f / 1000.0;
				float pixelHeight30_g330 = 1.0f / 1000.0;
				half2 pixelateduv30_g330 = half2((int)(texCoord1_g330.x / pixelWidth30_g330) * pixelWidth30_g330, (int)(texCoord1_g330.y / pixelHeight30_g330) * pixelHeight30_g330);
				float2 lerpResult32_g330 = lerp( texCoord1_g330 , pixelateduv30_g330 , (float)0);
				float2 break5_g330 = ( lerpResult32_g330 - float2( 0.5,0.5 ) );
				float2 break13_g329 = WU_EyeSize965;
				float WU_Blinking987 = _WakeUp_Blinking;
				float mulTime9_g329 = _Time.y * ( WU_Time984 / WU_Blinking987 );
				float2 appendResult7_g329 = (float2(break13_g329.x , ( break13_g329.y - (0.0 + (sin( mulTime9_g329 ) - -1.0) * (break13_g329.y - 0.0) / (1.0 - -1.0)) )));
				float2 break28_g330 = appendResult7_g329;
				float2 appendResult10_g330 = (float2(( ( break5_g330.x / _ScreenParams.y ) * break28_g330.x ) , ( ( break5_g330.y / _ScreenParams.x ) * break28_g330.y )));
				float temp_output_16_0_g330 = ( 1.0 - distance( ( appendResult10_g330 * WU_EyeRadius963 ) , float2( 0,0 ) ) );
				float4 appendResult24_g330 = (float4(temp_output_16_0_g330 , temp_output_16_0_g330 , temp_output_16_0_g330 , temp_output_16_0_g330));
				float4 temp_output_1032_0 = ( temp_output_390_0 * ( appendResult24_g330 * WU_Alpha525 ) );
				int lerpResult32_g333 = lerp( 0 , 1 , (float)(int)break668.a);
				float4 lerpResult21_g333 = lerp( lerpResult4_g333 , temp_output_1032_0 , (float)lerpResult32_g333);
				float4 WakeUpAction2508 = _WakeUpAction2;
				int lerpResult23_g333 = lerp( 0 , 1 , (float)(int)WakeUpAction2508.r);
				float4 lerpResult22_g333 = lerp( lerpResult21_g333 , temp_output_1032_0 , (float)lerpResult23_g333);
				float4 PostWakeUp18 = lerpResult22_g333;
...
/*ASEBEGIN
Version=18900
-1553;73;1113.2;572.6;2882.275;987.1912;4.577098;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;718;-31.90497,-305.9843;Inherit;False;1232.267;3227.794;Shaders;29;910;911;909;892;888;902;893;872;829;859;793;788;835;860;800;797;836;805;807;798;833;792;808;806;834;803;802;801;804;;0.6981132,0.6948202,0.6948202,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;396;1406.324,1092.287;Inherit;False;Uriel_TripleColorSelector;-1;;325;68eae7d6c234c244a816739ac0f6ff6b;0;7;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;389;-336.9988,1684.985;Inherit;False;Uriel_CuadrupleColorSelector;-1;;326;19200bcae6cce8140b6e878eb2345ccd;0;9;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;31;COLOR;0,0,0,0;False;30;INT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;659;1407.495,1683.975;Inherit;False;Uriel_TripleColorSelector;-1;;327;68eae7d6c234c244a816739ac0f6ff6b;0;7;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;390;-345.8241,2272.117;Inherit;False;Uriel_QuintupleColorSelector;-1;;328;31cee3057a501844bbe43a769aec214a;0;11;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;31;COLOR;0,0,0,0;False;30;INT;0;False;29;COLOR;0,0,0,0;False;28;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1032;958.67,2436.912;Inherit;False;Uriel_Eyes_2_WakeUpBlink;-1;;329;3f559232b69e6004ea00c86a10697d89;0;6;5;COLOR;0,0,0,0;False;26;FLOAT;0;False;10;FLOAT;2;False;16;FLOAT;2;False;15;FLOAT;150;False;14;FLOAT2;0.8,150;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1027;297.4649,2394.063;Inherit;False;Uriel_Eyes_1_QuickOpen;-1;;331;47e9cbd793375844f84e61b71de271c1;0;4;5;COLOR;0,0,0,0;False;16;FLOAT;2;False;7;FLOAT;150;False;9;FLOAT2;0.8,150;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;948;1200.752,2518.26;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;944;1417.781,2271.703;Inherit;False;Uriel_QuintupleColorSelector;-1;;333;31cee3057a501844bbe43a769aec214a;0;11;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;31;COLOR;0,0,0,0;False;30;INT;0;False;29;COLOR;0,0,0,0;False;28;INT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=75F62A2314A50428DDE59B13B7F38D4D06E8070E