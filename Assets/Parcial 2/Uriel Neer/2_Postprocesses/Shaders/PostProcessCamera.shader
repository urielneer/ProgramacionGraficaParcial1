	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float3 hsvTorgb3_g279 = RGBToHSV( saturate( ( ( ScreenRGB14 * float4( 0.5,0.5,0.5,0.5019608 ) ) + ( DrunkRGB1755 * float4( 0.125,0.125,0.125,0.1254902 ) ) + ( DrunkRGB2766 * float4( 0.125,0.125,0.125,0.1254902 ) ) + ( DrunkRGB3774 * float4( 0.125,0.125,0.125,0.1254902 ) ) + ( DrunkRGB4773 * float4( 0.1254902,0.1254902,0.1254902,0.1254902 ) ) ) ).rgb );
				float Dr_Alpha523 = _Drunk_Alpha;
				float lerpResult16_g279 = lerp( 0.0 , 1.0 , ( (_Drunk_Hue.x + (sin( _Time.y ) - -1.0) * (_Drunk_Hue.y - _Drunk_Hue.x) / (1.0 - -1.0)) * Dr_Alpha523 ));
				float lerpResult17_g279 = lerp( 0.0 , 1.0 , 1.0);
				float lerpResult18_g279 = lerp( 0.0 , 1.0 , 1.0);
				float3 hsvTorgb8_g279 = HSVToRGB( float3(( hsvTorgb3_g279.x * lerpResult16_g279 ),( hsvTorgb3_g279.y * lerpResult17_g279 ),( hsvTorgb3_g279.z * lerpResult18_g279 )) );
				float3 break863 = hsvTorgb8_g279;
				...
				int lerpResult14_g280 = lerp( 0 , 1 , (float)(int)break658.r);
				float4 lerpResult9_g280 = lerp( ScreenRGB14 , appendResult862 , (float)lerpResult14_g280);
				int lerpResult15_g280 = lerp( 0 , 1 , (float)(int)break658.g);
				float4 lerpResult5_g280 = lerp( lerpResult9_g280 , appendResult862 , (float)lerpResult15_g280);
				int lerpResult18_g280 = lerp( 0 , 1 , (float)(int)break658.b);
				float4 lerpResult4_g280 = lerp( lerpResult5_g280 , appendResult862 , (float)lerpResult18_g280);
				float4 PostDrunk16 = lerpResult4_g280;
				float IsDrunk49 = _IsDrunk;
				int lerpResult14_g327 = lerp( 0 , 1 , (float)(int)IsDrunk49);
				float4 lerpResult9_g327 = lerp( ScreenRGB14 , PostDrunk16 , (float)lerpResult14_g327);
				int lerpResult14_g281 = lerp( 0 , 1 , (float)(int)IsDrunk49);
				float4 lerpResult9_g281 = lerp( ScreenRGB14 , PostDrunk16 , (float)lerpResult14_g281);
				float4 temp_output_417_0 = lerpResult9_g281;
				...
				int lerpResult14_g309 = lerp( 0 , 1 , (float)(int)break368.r);
				float4 lerpResult9_g309 = lerp( temp_output_417_0 , temp_output_546_0 , (float)lerpResult14_g309);
				int lerpResult15_g309 = lerp( 0 , 1 , (float)(int)break368.g);
				float4 lerpResult5_g309 = lerp( lerpResult9_g309 , temp_output_546_0 , (float)lerpResult15_g309);
				float4 Screen215_g306 = ScreenRGB14;
				float3 hsvTorgb3_g308 = RGBToHSV( Screen215_g306.rgb );
				float lerpResult16_g308 = lerp( 0.0 , 1.0 , 1.0);
				float Time289_g306 = _Time.y;
				float FB_MinSaturation288 = _FlashBang_MinSaturation;
				float FB_MaxSaturation289 = _FlashBang_MaxSaturation;
				float Alpha308_g306 = FB_Alpha519;
				float lerpResult17_g308 = lerp( 0.0 , 1.0 , ( 1.0 - ( (FB_MinSaturation288 + (( sin( Time289_g306 ) * 0.2 ) - -1.0) * (FB_MaxSaturation289 - FB_MinSaturation288) / (1.0 - -1.0)) * Alpha308_g306 ) ));
				float lerpResult18_g308 = lerp( 0.0 , 1.0 , 1.0);
				float3 hsvTorgb8_g308 = HSVToRGB( float3(( hsvTorgb3_g308.x * lerpResult16_g308 ),( hsvTorgb3_g308.y * lerpResult17_g308 ),( hsvTorgb3_g308.z * lerpResult18_g308 )) );
				float3 break316_g306 = hsvTorgb8_g308;
				float4 appendResult317_g306 = (float4(break316_g306.x , break316_g306.y , break316_g306.z , 1.0));
				float FB_GradientTimeScale287 = _FlashBang_GradientTimeScale;
				float mulTime293_g306 = _Time.y * FB_GradientTimeScale287;
				float FlashBangTime291_g306 = mulTime293_g306;
				float temp_output_90_0_g306 = sin( FlashBangTime291_g306 );
				float FB_MinBorderSize290 = _FlashBang_MinBorderSize;
				float temp_output_170_0_g306 = FB_MinBorderSize290;
				float temp_output_171_0_g306 = ( temp_output_170_0_g306 / 4.0 );
				float temp_output_167_0_g306 = (( temp_output_170_0_g306 - temp_output_171_0_g306 ) + (temp_output_90_0_g306 - -1.0) * (( temp_output_170_0_g306 + temp_output_171_0_g306 ) - ( temp_output_170_0_g306 - temp_output_171_0_g306 )) / (1.0 - -1.0));
				float FB_MaxBorderSize291 = _FlashBang_MaxBorderSize;
				float temp_output_39_0_g306 = FB_MaxBorderSize291;
				float temp_output_176_0_g306 = ( temp_output_39_0_g306 / 4.0 );
				float temp_output_168_0_g306 = (( temp_output_39_0_g306 - temp_output_176_0_g306 ) + (temp_output_90_0_g306 - -1.0) * (( temp_output_39_0_g306 + temp_output_176_0_g306 ) - ( temp_output_39_0_g306 - temp_output_176_0_g306 )) / (1.0 - -1.0));
				float2 appendResult141_g306 = (float2(temp_output_167_0_g306 , temp_output_168_0_g306));
				float2 DistortionX43_g307 = appendResult141_g306;
				float2 break45_g307 = DistortionX43_g307;
				float2 appendResult140_g306 = (float2(0.5 , 0.5));
				float2 texCoord1_g307 = i.uv.xy * float2( 1,1 ) + appendResult140_g306;
				float2 break98_g307 = UC_Pixels891;
				float pixelWidth30_g307 =  1.0f / break98_g307.x;
				float pixelHeight30_g307 = 1.0f / break98_g307.y;
				half2 pixelateduv30_g307 = half2((int)(texCoord1_g307.x / pixelWidth30_g307) * pixelWidth30_g307, (int)(texCoord1_g307.y / pixelHeight30_g307) * pixelHeight30_g307);
				float2 lerpResult32_g307 = lerp( texCoord1_g307 , pixelateduv30_g307 , (float)(int)IsUsingCamera50);
				float2 break81_g307 = ( lerpResult32_g307 - float2( 0.5,0.5 ) );
				float PosX56_g307 = break81_g307.x;
				float smoothstepResult41_g307 = smoothstep( break45_g307.x , break45_g307.y , PosX56_g307);
				float2 break47_g307 = ( 1.0 - DistortionX43_g307 );
				float smoothstepResult42_g307 = smoothstep( break47_g307.x , break47_g307.y , PosX56_g307);
				float temp_output_40_0_g307 = ( smoothstepResult41_g307 * smoothstepResult42_g307 );
				float2 appendResult142_g306 = (float2(temp_output_167_0_g306 , temp_output_168_0_g306));
				float2 DistortionY71_g307 = appendResult142_g306;
				float2 break60_g307 = DistortionY71_g307;
				float PosY57_g307 = break81_g307.y;
				float smoothstepResult58_g307 = smoothstep( break60_g307.x , break60_g307.y , PosY57_g307);
				float2 break62_g307 = ( 1.0 - DistortionY71_g307 );
				float smoothstepResult61_g307 = smoothstep( break62_g307.x , break62_g307.y , PosY57_g307);
				float temp_output_65_0_g307 = ( smoothstepResult58_g307 * smoothstepResult61_g307 );
				float temp_output_72_0_g307 = ( temp_output_40_0_g307 * temp_output_65_0_g307 );
				float4 appendResult96_g307 = (float4(temp_output_72_0_g307 , temp_output_72_0_g307 , temp_output_72_0_g307 , temp_output_72_0_g307));
				float4 Color67_g306 = FB_Color278;
				float4 temp_output_872_0 = ( appendResult317_g306 + ( ( ( 1.0 - appendResult96_g307 ) * Color67_g306 ) * Alpha308_g306 ) );
				int lerpResult18_g309 = lerp( 0 , 1 , (float)(int)break368.b);
				float4 lerpResult4_g309 = lerp( lerpResult5_g309 , temp_output_872_0 , (float)lerpResult18_g309);
				int lerpResult32_g309 = lerp( 0 , 1 , (float)(int)break368.a);
				float4 lerpResult21_g309 = lerp( lerpResult4_g309 , temp_output_872_0 , (float)lerpResult32_g309);
				float4 PostFlashBang24 = lerpResult21_g309;
				float IsFlashBanged42 = _IsFlashBanged;
				int lerpResult15_g327 = lerp( 0 , 1 , (float)(int)IsFlashBanged42);
				float4 lerpResult5_g327 = lerp( lerpResult9_g327 , PostFlashBang24 , (float)lerpResult15_g327);
				int lerpResult14_g310 = lerp( 0 , 1 , (float)(int)IsDrunk49);
				float4 lerpResult9_g310 = lerp( ScreenRGB14 , PostDrunk16 , (float)lerpResult14_g310);
				int lerpResult15_g310 = lerp( 0 , 1 , (float)(int)IsFlashBanged42);
				float4 lerpResult5_g310 = lerp( lerpResult9_g310 , PostFlashBang24 , (float)lerpResult15_g310);
				float4 temp_output_392_0 = lerpResult5_g310;
				float2 Da_VignetteBlurr472 = _Damage_VignetteBlurr;
				float2 VignetteBlurr94_g311 = Da_VignetteBlurr472;
				float2 break226_g311 = VignetteBlurr94_g311;
				float4 temp_cast_53 = (break226_g311.x).xxxx;
				float4 temp_cast_54 = (break226_g311.y).xxxx;
				float2 texCoord1_g313 = i.uv.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Pixels33_g311 = UC_Pixels891;
				float2 break38_g311 = Pixels33_g311;
				float pixelWidth30_g313 =  1.0f / break38_g311.x;
				float pixelHeight30_g313 = 1.0f / break38_g311.y;
				half2 pixelateduv30_g313 = half2((int)(texCoord1_g313.x / pixelWidth30_g313) * pixelWidth30_g313, (int)(texCoord1_g313.y / pixelHeight30_g313) * pixelHeight30_g313);
				int IsPixelated32_g311 = (int)IsUsingCamera50;
				float2 lerpResult32_g313 = lerp( texCoord1_g313 , pixelateduv30_g313 , (float)IsPixelated32_g311);
				float2 break5_g313 = ( lerpResult32_g313 - float2( 0.5,0.5 ) );
				float temp_output_78_0_g311 = sin( _Time.y );
				float VignetteTime40_g311 = temp_output_78_0_g311;
				float3 Da_Speeds437 = _Damage_Speeds;
				float3 break7_g311 = Da_Speeds437;
				float SpeedRadius122_g311 = break7_g311.x;
				float temp_output_222_0_g311 = ( VignetteTime40_g311 * SpeedRadius122_g311 );
				float2 Da_Distortion436 = _Damage_Distortion;
				float2 Distortion34_g311 = Da_Distortion436;
				float2 break107_g311 = Distortion34_g311;
				float3 Da_FluctuationRange435 = _Damage_FluctuationRange;
				float3 break11_g311 = Da_FluctuationRange435;
				float FluctuationRange116_g311 = break11_g311.x;
				float temp_output_143_0_g311 = ( break107_g311.x * FluctuationRange116_g311 );
				float temp_output_144_0_g311 = ( break107_g311.y * FluctuationRange116_g311 );
				float2 appendResult97_g311 = (float2((( break107_g311.x - temp_output_143_0_g311 ) + (temp_output_222_0_g311 - -1.0) * (( break107_g311.x + temp_output_143_0_g311 ) - ( break107_g311.x - temp_output_143_0_g311 )) / (1.0 - -1.0)) , (( break107_g311.y - temp_output_144_0_g311 ) + (temp_output_222_0_g311 - -1.0) * (( break107_g311.y + temp_output_144_0_g311 ) - ( break107_g311.y - temp_output_144_0_g311 )) / (1.0 - -1.0))));
				float2 VignetteDistortion1146_g311 = appendResult97_g311;
				float2 break28_g313 = VignetteDistortion1146_g311;
				float2 appendResult10_g313 = (float2(( ( break5_g313.x / _ScreenParams.y ) * break28_g313.x ) , ( ( break5_g313.y / _ScreenParams.x ) * break28_g313.y )));
				float3 Da_Radiuses434 = _Damage_Radiuses;
				float3 break9_g311 = Da_Radiuses434;
				float Radius113_g311 = break9_g311.x;
				float temp_output_16_0_g313 = ( 1.0 - distance( ( appendResult10_g313 * Radius113_g311 ) , float2( 0,0 ) ) );
				float4 appendResult24_g313 = (float4(temp_output_16_0_g313 , temp_output_16_0_g313 , temp_output_16_0_g313 , temp_output_16_0_g313));
				float4 smoothstepResult80_g311 = smoothstep( temp_cast_53 , temp_cast_54 , appendResult24_g313);
				float4 Da_Color1440 = _Damage_Color1;
				float4 Color131_g311 = Da_Color1440;
				float4 temp_cast_57 = (break226_g311.x).xxxx;
				float4 temp_cast_58 = (break226_g311.y).xxxx;
				float2 texCoord1_g314 = i.uv.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break44_g311 = Pixels33_g311;
				float pixelWidth30_g314 =  1.0f / break44_g311.x;
				float pixelHeight30_g314 = 1.0f / break44_g311.y;
				half2 pixelateduv30_g314 = half2((int)(texCoord1_g314.x / pixelWidth30_g314) * pixelWidth30_g314, (int)(texCoord1_g314.y / pixelHeight30_g314) * pixelHeight30_g314);
				float2 lerpResult32_g314 = lerp( texCoord1_g314 , pixelateduv30_g314 , (float)IsPixelated32_g311);
				float2 break5_g314 = ( lerpResult32_g314 - float2( 0.5,0.5 ) );
				float SpeedRadius223_g311 = break7_g311.y;
				float temp_output_223_0_g311 = ( VignetteTime40_g311 * SpeedRadius223_g311 );
				float2 break172_g311 = Distortion34_g311;
				float FluctuationRange217_g311 = break11_g311.y;
				float temp_output_175_0_g311 = ( break172_g311.x * FluctuationRange217_g311 );
				float temp_output_176_0_g311 = ( break172_g311.y * FluctuationRange217_g311 );
				float2 appendResult181_g311 = (float2((( break172_g311.x - temp_output_175_0_g311 ) + (temp_output_223_0_g311 - -1.0) * (( break172_g311.x + temp_output_175_0_g311 ) - ( break172_g311.x - temp_output_175_0_g311 )) / (1.0 - -1.0)) , (( break172_g311.y - temp_output_176_0_g311 ) + (temp_output_223_0_g311 - -1.0) * (( break172_g311.y + temp_output_176_0_g311 ) - ( break172_g311.y - temp_output_176_0_g311 )) / (1.0 - -1.0))));
				float2 VignetteDistortion2182_g311 = appendResult181_g311;
				float2 break28_g314 = VignetteDistortion2182_g311;
				float2 appendResult10_g314 = (float2(( ( break5_g314.x / _ScreenParams.y ) * break28_g314.x ) , ( ( break5_g314.y / _ScreenParams.x ) * break28_g314.y )));
				float Radius214_g311 = break9_g311.y;
				float temp_output_16_0_g314 = ( 1.0 - distance( ( appendResult10_g314 * Radius214_g311 ) , float2( 0,0 ) ) );
				float4 appendResult24_g314 = (float4(temp_output_16_0_g314 , temp_output_16_0_g314 , temp_output_16_0_g314 , temp_output_16_0_g314));
				float4 smoothstepResult81_g311 = smoothstep( temp_cast_57 , temp_cast_58 , appendResult24_g314);
				float4 Da_Color2439 = _Damage_Color2;
				float4 Color262_g311 = Da_Color2439;
				float4 temp_cast_60 = (break226_g311.x).xxxx;
				float4 temp_cast_61 = (break226_g311.y).xxxx;
				float2 texCoord1_g312 = i.uv.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break54_g311 = Pixels33_g311;
				float pixelWidth30_g312 =  1.0f / break54_g311.x;
				float pixelHeight30_g312 = 1.0f / break54_g311.y;
				half2 pixelateduv30_g312 = half2((int)(texCoord1_g312.x / pixelWidth30_g312) * pixelWidth30_g312, (int)(texCoord1_g312.y / pixelHeight30_g312) * pixelHeight30_g312);
				float2 lerpResult32_g312 = lerp( texCoord1_g312 , pixelateduv30_g312 , (float)IsPixelated32_g311);
				float2 break5_g312 = ( lerpResult32_g312 - float2( 0.5,0.5 ) );
				float SpeedRadius324_g311 = break7_g311.z;
				float temp_output_224_0_g311 = ( VignetteTime40_g311 * SpeedRadius324_g311 );
				float2 break207_g311 = Distortion34_g311;
				float FluctuationRange318_g311 = break11_g311.z;
				float temp_output_209_0_g311 = ( break207_g311.x * FluctuationRange318_g311 );
				float temp_output_210_0_g311 = ( break207_g311.y * FluctuationRange318_g311 );
				float2 appendResult213_g311 = (float2((( break207_g311.x - temp_output_209_0_g311 ) + (temp_output_224_0_g311 - -1.0) * (( break207_g311.x + temp_output_209_0_g311 ) - ( break207_g311.x - temp_output_209_0_g311 )) / (1.0 - -1.0)) , (( break207_g311.y - temp_output_210_0_g311 ) + (temp_output_224_0_g311 - -1.0) * (( break207_g311.y + temp_output_210_0_g311 ) - ( break207_g311.y - temp_output_210_0_g311 )) / (1.0 - -1.0))));
				float2 VignetteDistortion3214_g311 = appendResult213_g311;
				float2 break28_g312 = VignetteDistortion3214_g311;
				float2 appendResult10_g312 = (float2(( ( break5_g312.x / _ScreenParams.y ) * break28_g312.x ) , ( ( break5_g312.y / _ScreenParams.x ) * break28_g312.y )));
				float Radius315_g311 = break9_g311.z;
				float temp_output_16_0_g312 = ( 1.0 - distance( ( appendResult10_g312 * Radius315_g311 ) , float2( 0,0 ) ) );
				float4 appendResult24_g312 = (float4(temp_output_16_0_g312 , temp_output_16_0_g312 , temp_output_16_0_g312 , temp_output_16_0_g312));
				float4 smoothstepResult82_g311 = smoothstep( temp_cast_60 , temp_cast_61 , appendResult24_g312);
				float4 Da_Color3438 = _Damage_Color3;
				float4 Color364_g311 = Da_Color3438;
				float Da_Alpha520 = _Damage_Alpha;
				float4 temp_output_698_0 = ( ( ( ( ( 1.0 - smoothstepResult80_g311 ) * Color131_g311 ) + ( ( 1.0 - smoothstepResult81_g311 ) * Color262_g311 ) + ( ( 1.0 - smoothstepResult82_g311 ) * Color364_g311 ) ) * Da_Alpha520 ) + temp_output_392_0 );
				float4 DamageAction1256 = _DamageAction1;
				float4 break541 = DamageAction1256;
				int lerpResult14_g315 = lerp( 0 , 1 , (float)(int)break541.r);
				float4 lerpResult9_g315 = lerp( temp_output_392_0 , temp_output_698_0 , (float)lerpResult14_g315);
				int lerpResult15_g315 = lerp( 0 , 1 , (float)(int)break541.g);
				float4 lerpResult5_g315 = lerp( lerpResult9_g315 , temp_output_698_0 , (float)lerpResult15_g315);
				int lerpResult18_g315 = lerp( 0 , 1 , (float)(int)break541.b);
				float4 lerpResult4_g315 = lerp( lerpResult5_g315 , temp_output_698_0 , (float)lerpResult18_g315);
				float4 PostDamage22 = lerpResult4_g315;
				float IsDamaged48 = _IsDamaged;
				int lerpResult18_g327 = lerp( 0 , 1 , (float)(int)IsDamaged48);
				float4 lerpResult4_g327 = lerp( lerpResult5_g327 , PostDamage22 , (float)lerpResult18_g327);
				int lerpResult14_g316 = lerp( 0 , 1 , (float)(int)IsDrunk49);
				float4 lerpResult9_g316 = lerp( ScreenRGB14 , PostDrunk16 , (float)lerpResult14_g316);
				int lerpResult15_g316 = lerp( 0 , 1 , (float)(int)IsFlashBanged42);
				float4 lerpResult5_g316 = lerp( lerpResult9_g316 , PostFlashBang24 , (float)lerpResult15_g316);
				int lerpResult18_g316 = lerp( 0 , 1 , (float)(int)IsDamaged48);
				float4 lerpResult4_g316 = lerp( lerpResult5_g316 , PostDamage22 , (float)lerpResult18_g316);
				float4 temp_output_386_0 = lerpResult4_g316;
				float4 Screen12_g317 = temp_output_386_0;
				float3 hsvTorgb3_g319 = RGBToHSV( Screen12_g317.rgb );
				float lerpResult16_g319 = lerp( 0.0 , 1.0 , 1.0);
				float lerpResult17_g319 = lerp( 0.0 , 1.0 , 1.0);
				float Time38_g317 = _Time.y;
				float2 H_ValueFrame619 = _Heal_ValueFrame;
				float2 break634 = H_ValueFrame619;
				float H_Alpha522 = _Heal_Alpha;
				float Alpha30_g317 = H_Alpha522;
				float lerpResult18_g319 = lerp( 0.0 , 1.0 , ( 1.0 - ( (break634.x + (( sin( Time38_g317 ) * 0.2 ) - -1.0) * (break634.y - break634.x) / (1.0 - -1.0)) * Alpha30_g317 ) ));
				float3 hsvTorgb8_g319 = HSVToRGB( float3(( hsvTorgb3_g319.x * lerpResult16_g319 ),( hsvTorgb3_g319.y * lerpResult17_g319 ),( hsvTorgb3_g319.z * lerpResult18_g319 )) );
				float3 break44_g317 = hsvTorgb8_g319;
				float4 appendResult16_g317 = (float4(break44_g317.x , break44_g317.y , break44_g317.z , 1.0));
				float4 H_ColorTint1595 = _Heal_TintColor1;
				float4 TintColorA63_g317 = H_ColorTint1595;
				float4 H_ColorTint2599 = _Heal_TintColor2;
				float4 TintColorB66_g317 = H_ColorTint2599;
				float4 lerpResult85_g317 = lerp( TintColorA63_g317 , TintColorB66_g317 , (0.0 + (sin( _Time.y ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)));
				float H_GradientTimeScale621 = _Heal_GradientTimeScale;
				float mulTime19_g317 = _Time.y * H_GradientTimeScale621;
				float FlashBangTime33_g317 = mulTime19_g317;
				float temp_output_51_0_g317 = sin( FlashBangTime33_g317 );
				float2 H_BorderSize620 = _Heal_BorderSize;
				float2 break637 = H_BorderSize620;
				float temp_output_52_0_g317 = break637.x;
				float temp_output_57_0_g317 = ( temp_output_52_0_g317 / 4.0 );
				float temp_output_49_0_g317 = (( temp_output_52_0_g317 - temp_output_57_0_g317 ) + (temp_output_51_0_g317 - -1.0) * (( temp_output_52_0_g317 + temp_output_57_0_g317 ) - ( temp_output_52_0_g317 - temp_output_57_0_g317 )) / (1.0 - -1.0));
				float temp_output_40_0_g317 = break637.y;
				float temp_output_50_0_g317 = ( temp_output_40_0_g317 / 4.0 );
				float temp_output_42_0_g317 = (( temp_output_40_0_g317 - temp_output_50_0_g317 ) + (temp_output_51_0_g317 - -1.0) * (( temp_output_40_0_g317 + temp_output_50_0_g317 ) - ( temp_output_40_0_g317 - temp_output_50_0_g317 )) / (1.0 - -1.0));
				float2 appendResult35_g317 = (float2(temp_output_49_0_g317 , temp_output_42_0_g317));
				float2 DistortionX43_g318 = appendResult35_g317;
				float2 break45_g318 = DistortionX43_g318;
				float2 appendResult58_g317 = (float2(0.5 , 0.5));
				float2 texCoord1_g318 = i.uv.xy * float2( 1,1 ) + appendResult58_g317;
				float2 break98_g318 = UC_Pixels891;
				float pixelWidth30_g318 =  1.0f / break98_g318.x;
				float pixelHeight30_g318 = 1.0f / break98_g318.y;
				half2 pixelateduv30_g318 = half2((int)(texCoord1_g318.x / pixelWidth30_g318) * pixelWidth30_g318, (int)(texCoord1_g318.y / pixelHeight30_g318) * pixelHeight30_g318);
				float2 lerpResult32_g318 = lerp( texCoord1_g318 , pixelateduv30_g318 , (float)(int)IsUsingCamera50);
				float2 break81_g318 = ( lerpResult32_g318 - float2( 0.5,0.5 ) );
				float PosX56_g318 = break81_g318.x;
				float smoothstepResult41_g318 = smoothstep( break45_g318.x , break45_g318.y , PosX56_g318);
				float2 break47_g318 = ( 1.0 - DistortionX43_g318 );
				float smoothstepResult42_g318 = smoothstep( break47_g318.x , break47_g318.y , PosX56_g318);
				float temp_output_40_0_g318 = ( smoothstepResult41_g318 * smoothstepResult42_g318 );
				float2 appendResult47_g317 = (float2(temp_output_49_0_g317 , temp_output_42_0_g317));
				float2 DistortionY71_g318 = appendResult47_g317;
				float2 break60_g318 = DistortionY71_g318;
				float PosY57_g318 = break81_g318.y;
				float smoothstepResult58_g318 = smoothstep( break60_g318.x , break60_g318.y , PosY57_g318);
				float2 break62_g318 = ( 1.0 - DistortionY71_g318 );
				float smoothstepResult61_g318 = smoothstep( break62_g318.x , break62_g318.y , PosY57_g318);
				float temp_output_65_0_g318 = ( smoothstepResult58_g318 * smoothstepResult61_g318 );
				float temp_output_72_0_g318 = ( temp_output_40_0_g318 * temp_output_65_0_g318 );
				float4 appendResult96_g318 = (float4(temp_output_72_0_g318 , temp_output_72_0_g318 , temp_output_72_0_g318 , temp_output_72_0_g318));
				float4 temp_output_14_0_g317 = appendResult96_g318;
				float4 H_ColorBorder1594 = _Heal_BorderColor1;
				float4 BorderColorA13_g317 = H_ColorBorder1594;
				float4 H_ColorBorder2601 = _Heal_BorderColor2;
				float4 BorderColorB70_g317 = H_ColorBorder2601;
				float4 lerpResult72_g317 = lerp( BorderColorA13_g317 , BorderColorB70_g317 , (0.0 + (sin( _Time.y ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)));
				float4 screenPos = i.ase_texcoord4;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float H_LineSpeed622 = _Heal_LineSpeed;
				float mulTime21_g317 = _Time.y * H_LineSpeed622;
				float H_LineFrequency624 = _Heal_LineFrequency;
				float H_LineSharpness625 = 0.1;
				float4 H_ColorLine1593 = _Heal_LineColor1;
				float4 LineColorA65_g317 = H_ColorLine1593;
				float4 H_ColorLine2600 = _Heal_LineColor2;
				float4 LineColorB71_g317 = H_ColorLine2600;
				float4 lerpResult78_g317 = lerp( LineColorA65_g317 , LineColorB71_g317 , (0.0 + (sin( _Time.y ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)));
				float H_LineTransparency623 = 0.5;
				float4 temp_output_695_61 = ( ( appendResult16_g317 * lerpResult85_g317 ) + ( ( ( 1.0 - temp_output_14_0_g317 ) * lerpResult72_g317 ) * Alpha30_g317 ) + ( ( ( step( frac( ( ( ase_screenPosNorm.y - mulTime21_g317 ) * H_LineFrequency624 ) ) , H_LineSharpness625 ) * lerpResult78_g317 ) * H_LineTransparency623 ) * Alpha30_g317 ) );
				float4 HealAction1257 = _HealAction1;
				float4 break585 = HealAction1257;
				int lerpResult14_g320 = lerp( 0 , 1 , (float)(int)break585.r);
				float4 lerpResult9_g320 = lerp( temp_output_386_0 , temp_output_695_61 , (float)lerpResult14_g320);
				int lerpResult15_g320 = lerp( 0 , 1 , (float)(int)break585.g);
				float4 lerpResult5_g320 = lerp( lerpResult9_g320 , temp_output_695_61 , (float)lerpResult15_g320);
				int lerpResult18_g320 = lerp( 0 , 1 , (float)(int)break585.b);
				float4 lerpResult4_g320 = lerp( lerpResult5_g320 , temp_output_695_61 , (float)lerpResult18_g320);
				float4 PostHeal20 = lerpResult4_g320;
				float IsHealing52 = _IsHealing;
				int lerpResult32_g327 = lerp( 0 , 1 , (float)(int)IsHealing52);
				float4 lerpResult21_g327 = lerp( lerpResult4_g327 , PostHeal20 , (float)lerpResult32_g327);
				int lerpResult14_g321 = lerp( 0 , 1 , (float)(int)IsDrunk49);
				float4 lerpResult9_g321 = lerp( ScreenRGB14 , PostDrunk16 , (float)lerpResult14_g321);
				int lerpResult15_g321 = lerp( 0 , 1 , (float)(int)IsFlashBanged42);
				float4 lerpResult5_g321 = lerp( lerpResult9_g321 , PostFlashBang24 , (float)lerpResult15_g321);
				int lerpResult18_g321 = lerp( 0 , 1 , (float)(int)IsDamaged48);
				float4 lerpResult4_g321 = lerp( lerpResult5_g321 , PostDamage22 , (float)lerpResult18_g321);
				int lerpResult32_g321 = lerp( 0 , 1 , (float)(int)IsHealing52);
				float4 lerpResult21_g321 = lerp( lerpResult4_g321 , PostHeal20 , (float)lerpResult32_g321);
				float4 temp_output_389_0 = lerpResult21_g321;
				float3 hsvTorgb3_g325 = RGBToHSV( temp_output_389_0.rgb );
				float lerpResult16_g325 = lerp( 0.0 , 1.0 , 1.0);
				float lerpResult17_g325 = lerp( 0.0 , 1.0 , 0.7);
				float lerpResult18_g325 = lerp( 0.0 , 1.0 , 1.0);
				float3 hsvTorgb8_g325 = HSVToRGB( float3(( hsvTorgb3_g325.x * lerpResult16_g325 ),( hsvTorgb3_g325.y * lerpResult17_g325 ),( hsvTorgb3_g325.z * lerpResult18_g325 )) );
				float3 break12_g322 = hsvTorgb8_g325;
				float4 appendResult13_g322 = (float4(break12_g322.x , break12_g322.y , break12_g322.z , 1.0));
				float UC_Alpha524 = _UseCamera_Alpha;
				float Alpha79_g322 = UC_Alpha524;
				float4 temp_output_9_0_g322 = ( ase_screenPosNorm + _Time.y );
				float simplePerlin3D10_g322 = snoise( temp_output_9_0_g322.xyz*30.0 );
				simplePerlin3D10_g322 = simplePerlin3D10_g322*0.5 + 0.5;
				float2 break19_g323 = float2( -18,0.05 );
				float4 temp_output_1_0_g323 = temp_output_9_0_g322;
				float4 sinIn7_g323 = sin( temp_output_1_0_g323 );
				float4 sinInOffset6_g323 = sin( ( temp_output_1_0_g323 + 1.0 ) );
				float lerpResult20_g323 = lerp( break19_g323.x , break19_g323.y , frac( ( sin( ( ( sinIn7_g323 - sinInOffset6_g323 ) * 91.2228 ) ) * 43758.55 ) ).x);
				float4 color56_g322 = IsGammaSpace() ? float4(0.2126,0.7152,0.0722,1) : float4(0.03716727,0.4699402,0.006236819,1);
				float4 ToFloat66_g322 = color56_g322;
				float dotResult55_g322 = dot( ( lerpResult20_g323 + sinIn7_g323 ) , ToFloat66_g322 );
				float temp_output_18_0_g322 = ( Alpha79_g322 * ( step( simplePerlin3D10_g322 , (0.05 + (sin( _SinTime.w ) - -1.0) * (0.1 - 0.05) / (1.0 - -1.0)) ) + ( 1.0 - step( dotResult55_g322 , 0.0 ) ) ) );
				float4 appendResult59_g322 = (float4(temp_output_18_0_g322 , temp_output_18_0_g322 , temp_output_18_0_g322 , 1.0));
				float2 UC_RecDisplacement908 = _UseCamera_RecDisplacement;
				float2 texCoord1_g324 = i.uv.xy * float2( 1,1 ) + UC_RecDisplacement908;
				float2 break43_g322 = UC_Pixels891;
				float pixelWidth30_g324 =  1.0f / break43_g322.x;
				float pixelHeight30_g324 = 1.0f / break43_g322.y;
				half2 pixelateduv30_g324 = half2((int)(texCoord1_g324.x / pixelWidth30_g324) * pixelWidth30_g324, (int)(texCoord1_g324.y / pixelHeight30_g324) * pixelHeight30_g324);
				float2 lerpResult32_g324 = lerp( texCoord1_g324 , pixelateduv30_g324 , (float)(int)IsUsingCamera50);
				float2 break5_g324 = ( lerpResult32_g324 - float2( 0.5,0.5 ) );
				float2 UC_RecDistortion906 = _UseCamera_RecDistortion;
				float2 break28_g324 = UC_RecDistortion906;
				float2 appendResult10_g324 = (float2(( ( break5_g324.x / _ScreenParams.y ) * break28_g324.x ) , ( ( break5_g324.y / _ScreenParams.x ) * break28_g324.y )));
				float UC_RecRadius904 = _UseCamera_RecRadius;
				float temp_output_16_0_g324 = ( 1.0 - distance( ( appendResult10_g324 * UC_RecRadius904 ) , float2( 0,0 ) ) );
				float4 appendResult24_g324 = (float4(temp_output_16_0_g324 , temp_output_16_0_g324 , temp_output_16_0_g324 , temp_output_16_0_g324));
				float4 temp_output_50_0_g322 = step( appendResult24_g324 , float4( 0,0,0,0 ) );
				float mulTime74_g322 = _Time.y * 2.0;
				float temp_output_73_0_g322 = step( 0.0 , sin( mulTime74_g322 ) );
				float temp_output_77_0_g322 = ( 1.0 - temp_output_73_0_g322 );
				float4 lerpResult78_g322 = lerp( ( temp_output_50_0_g322 * Alpha79_g322 ) , float4( 1,1,1,1 ) , temp_output_77_0_g322);
				float4 lerpResult76_g322 = lerp( ( 1.0 - ( temp_output_50_0_g322 * temp_output_73_0_g322 ) ) , float4( 0,0,0,0 ) , temp_output_77_0_g322);
				float4 color53_g322 = IsGammaSpace() ? float4(1,0,0,1) : float4(1,0,0,1);
				float4 temp_output_1019_0 = ( ( ( appendResult13_g322 + appendResult59_g322 ) * lerpResult78_g322 ) + ( lerpResult76_g322 * ( Alpha79_g322 * color53_g322 ) ) );
				float4 UseCameraAction1253 = _UseCameraAction1;
				float4 break661 = UseCameraAction1253;
				int lerpResult14_g326 = lerp( 0 , 1 , (float)(int)break661.r);
				float4 lerpResult9_g326 = lerp( temp_output_389_0 , temp_output_1019_0 , (float)lerpResult14_g326);
				int lerpResult15_g326 = lerp( 0 , 1 , (float)(int)break661.g);
				float4 lerpResult5_g326 = lerp( lerpResult9_g326 , temp_output_1019_0 , (float)lerpResult15_g326);
				int lerpResult18_g326 = lerp( 0 , 1 , (float)(int)break661.b);
				float4 lerpResult4_g326 = lerp( lerpResult5_g326 , temp_output_1019_0 , (float)lerpResult18_g326);
				float4 PostCamera27 = lerpResult4_g326;
				int lerpResult23_g327 = lerp( 0 , 1 , (float)(int)IsUsingCamera50);
				float4 lerpResult22_g327 = lerp( lerpResult21_g327 , PostCamera27 , (float)lerpResult23_g327);
				float4 temp_output_390_0 = lerpResult22_g327;
				float WU_Alpha525 = _WakeUp_Alpha;
				float4 WakeUpAction1258 = _WakeUpAction1;
				float4 break668 = WakeUpAction1258;
				int lerpResult14_g332 = lerp( 0 , 1 , (float)(int)break668.r);
				float4 lerpResult9_g332 = lerp( temp_output_390_0 , ( temp_output_390_0 * WU_Alpha525 ) , (float)lerpResult14_g332);
				int lerpResult15_g332 = lerp( 0 , 1 , (float)(int)break668.g);
				float4 lerpResult5_g332 = lerp( lerpResult9_g332 , float4( 0,0,0,0 ) , (float)lerpResult15_g332);
				float2 texCoord1_g331 = i.uv.xy * float2( 1,1 ) + float2( 0,0 );
				float pixelWidth30_g331 =  1.0f / 1000.0;
				float pixelHeight30_g331 = 1.0f / 1000.0;
				half2 pixelateduv30_g331 = half2((int)(texCoord1_g331.x / pixelWidth30_g331) * pixelWidth30_g331, (int)(texCoord1_g331.y / pixelHeight30_g331) * pixelHeight30_g331);
				float2 lerpResult32_g331 = lerp( texCoord1_g331 , pixelateduv30_g331 , (float)0);
				float2 break5_g331 = ( lerpResult32_g331 - float2( 0.5,0.5 ) );
				float2 WU_EyeSize965 = _WakeUp_EyeSize;
				float2 break11_g330 = WU_EyeSize965;
				float WU_Time984 = _WakeUp_Time;
				float mulTime15_g330 = _Time.y * WU_Time984;
				float temp_output_17_0_g330 = (0.0 + (sin( mulTime15_g330 ) - -1.0) * (break11_g330.y - 0.0) / (1.0 - -1.0));
				float2 appendResult10_g330 = (float2(break11_g330.x , temp_output_17_0_g330));
				float2 break28_g331 = appendResult10_g330;
				float2 appendResult10_g331 = (float2(( ( break5_g331.x / _ScreenParams.y ) * break28_g331.x ) , ( ( break5_g331.y / _ScreenParams.x ) * break28_g331.y )));
				float WU_EyeRadius963 = _WakeUp_EyeRadius;
				float temp_output_16_0_g331 = ( 1.0 - distance( ( appendResult10_g331 * WU_EyeRadius963 ) , float2( 0,0 ) ) );
				float4 appendResult24_g331 = (float4(temp_output_16_0_g331 , temp_output_16_0_g331 , temp_output_16_0_g331 , temp_output_16_0_g331));
				int lerpResult18_g332 = lerp( 0 , 1 , (float)(int)break668.b);
				float4 lerpResult4_g332 = lerp( lerpResult5_g332 , ( temp_output_390_0 * appendResult24_g331 ) , (float)lerpResult18_g332);
				float2 texCoord1_g329 = i.uv.xy * float2( 1,1 ) + float2( 0,0 );
				float pixelWidth30_g329 =  1.0f / 1000.0;
				float pixelHeight30_g329 = 1.0f / 1000.0;
				half2 pixelateduv30_g329 = half2((int)(texCoord1_g329.x / pixelWidth30_g329) * pixelWidth30_g329, (int)(texCoord1_g329.y / pixelHeight30_g329) * pixelHeight30_g329);
				float2 lerpResult32_g329 = lerp( texCoord1_g329 , pixelateduv30_g329 , (float)0);
				float2 break5_g329 = ( lerpResult32_g329 - float2( 0.5,0.5 ) );
				float2 break13_g328 = WU_EyeSize965;
				float WU_Blinking987 = _WakeUp_Blinking;
				float mulTime9_g328 = _Time.y * ( WU_Time984 / WU_Blinking987 );
				float2 appendResult7_g328 = (float2(break13_g328.x , ( break13_g328.y - (0.0 + (sin( mulTime9_g328 ) - -1.0) * (break13_g328.y - 0.0) / (1.0 - -1.0)) )));
				float2 break28_g329 = appendResult7_g328;
				float2 appendResult10_g329 = (float2(( ( break5_g329.x / _ScreenParams.y ) * break28_g329.x ) , ( ( break5_g329.y / _ScreenParams.x ) * break28_g329.y )));
				float temp_output_16_0_g329 = ( 1.0 - distance( ( appendResult10_g329 * WU_EyeRadius963 ) , float2( 0,0 ) ) );
				float4 appendResult24_g329 = (float4(temp_output_16_0_g329 , temp_output_16_0_g329 , temp_output_16_0_g329 , temp_output_16_0_g329));
				float4 temp_output_1032_0 = ( temp_output_390_0 * ( appendResult24_g329 * WU_Alpha525 ) );
				int lerpResult32_g332 = lerp( 0 , 1 , (float)(int)break668.a);
				float4 lerpResult21_g332 = lerp( lerpResult4_g332 , temp_output_1032_0 , (float)lerpResult32_g332);
				float4 WakeUpAction2508 = _WakeUpAction2;
				int lerpResult23_g332 = lerp( 0 , 1 , (float)(int)WakeUpAction2508.r);
				float4 lerpResult22_g332 = lerp( lerpResult21_g332 , temp_output_1032_0 , (float)lerpResult23_g332);
				float4 PostWakeUp18 = lerpResult22_g332;
...
/*ASEBEGIN
Version=18900
-1640;73;1182;533.4;2072.129;426.954;4.577098;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;718;-31.90497,-305.9843;Inherit;False;1232.267;3227.794;Shaders;33;901;910;911;909;892;888;902;900;899;898;893;872;829;859;793;788;835;860;800;797;836;805;807;798;833;792;808;806;834;803;802;801;804;;0.6981132,0.6948202,0.6948202,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;829;843.8026,-206.641;Inherit;False;Uriel_HSVReadjustment;-1;;279;8b9acfc5fb713664a9fa50d7d5dae1d8;0;4;9;COLOR;0,0,0,0;False;10;FLOAT;0.5;False;11;FLOAT;1;False;12;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;656;1405.457,-230.0249;Inherit;False;Uriel_TripleColorSelector;-1;;280;68eae7d6c234c244a816739ac0f6ff6b;0;7;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;417;-337.0784,219.7459;Inherit;False;Uriel_SimpleColorSelector;-1;;281;211687b70dc7e754fa92527f6fd124ea;0;3;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;844;-67.33362,249.6071;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;499;760.006,-922.1605;Inherit;False;Property;_FlashBang_Alpha;FlashBang_Alpha;38;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;872;904.3831,346.819;Inherit;False;Uriel_FlashBang_2_RegainSight;-1;;306;8afafd4ab87642a498d39a82af6dab06;0;10;1;COLOR;0,0,0,0;False;298;COLOR;0,0,0,0;False;292;FLOAT;0;False;179;FLOAT;0;False;305;FLOAT;0;False;170;FLOAT;0.025;False;39;FLOAT;0.025;False;307;FLOAT;0.3;False;300;INT;0;False;301;FLOAT2;1000,1000;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;518;1414.532,225.9433;Inherit;False;Uriel_CuadrupleColorSelector;-1;;309;19200bcae6cce8140b6e878eb2345ccd;0;9;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;31;COLOR;0,0,0,0;False;30;INT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;39;264.3641,-744.2711;Inherit;False;Property;_IsFlashBanged;IsFlashBanged?;1;2;[HideInInspector];[IntRange];Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;392;-345.7923,669.4065;Inherit;False;Uriel_DoubleColorSelector;-1;;310;5f9106392216f6346a0866b5250f9a30;0;5;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;498;771.7878,-853.6306;Inherit;False;Property;_Damage_Alpha;Damage_Alpha;37;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;698;732.8032,694.3967;Inherit;False;Uriel_Damage_Loop;-1;;311;80f18160e2fc290448fd9b9fd30a867f;0;13;237;FLOAT;0;False;76;COLOR;0,0,0,0;False;8;FLOAT3;3000,1500,500;False;6;FLOAT3;4,6,8;False;35;FLOAT2;0.98,2.25;False;10;FLOAT3;0.075,0.075,0.075;False;95;FLOAT2;0,0.1;False;30;COLOR;0.4705882,0,0,1;False;63;COLOR;0.5176471,0,0.03529412,1;False;65;COLOR;0.5490196,0.05098039,0,1;False;242;FLOAT;0;False;28;INT;0;False;29;FLOAT2;1000,1000;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;536;1407.169,670.2787;Inherit;False;Uriel_TripleColorSelector;-1;;315;68eae7d6c234c244a816739ac0f6ff6b;0;7;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;626;-1739.393,1055.503;Inherit;False;3611.899;593.5086;Heal;68;594;600;601;593;595;599;597;592;598;596;590;591;629;630;632;602;603;605;606;619;604;620;622;621;624;607;623;608;625;396;585;676;675;677;674;584;672;678;679;673;695;635;639;628;643;641;642;644;645;640;646;637;627;636;634;633;638;56;55;59;58;57;60;386;787;21;20;887;;0.467875,1,0,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;386;-373.1906,1089.716;Inherit;False;Uriel_TripleColorSelector;-1;;316;68eae7d6c234c244a816739ac0f6ff6b;0;7;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;500;1441.326,-920.9186;Inherit;False;Property;_Heal_Alpha;Heal_Alpha;39;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;396;1406.324,1092.287;Inherit;False;Uriel_TripleColorSelector;-1;;320;68eae7d6c234c244a816739ac0f6ff6b;0;7;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;389;-336.9988,1684.985;Inherit;False;Uriel_CuadrupleColorSelector;-1;;321;19200bcae6cce8140b6e878eb2345ccd;0;9;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;31;COLOR;0,0,0,0;False;30;INT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;898;-29.11265,1716.885;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;502;1100.229,-851.4199;Inherit;False;Property;_UseCamera_Alpha;UseCamera_Alpha;41;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;899;-28.66501,1716.033;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.WireNode;900;-28.27108,1736.876;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.WireNode;901;-30.01871,1736.876;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1019;883.0569,1706.491;Inherit;False;Uriel_Camera;-1;;322;08bd67d8e8b398a46a05ccd8dcc9236a;0;7;4;COLOR;0,0,0,0;False;40;FLOAT;3000;False;41;FLOAT2;1,2;False;39;FLOAT2;0,0;False;6;FLOAT;0.3;False;44;INT;1;False;42;FLOAT2;1000,1000;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;659;1407.495,1683.975;Inherit;False;Uriel_TripleColorSelector;-1;;326;68eae7d6c234c244a816739ac0f6ff6b;0;7;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;874;-826.1793,2226.244;Inherit;False;2698.893;693.751;Camera;52;984;983;963;987;965;986;962;964;18;944;670;948;951;668;953;954;966;671;967;669;981;947;985;998;666;980;979;664;946;665;978;992;991;990;1003;996;995;993;994;390;80;74;72;77;79;70;26;73;71;78;76;1031;;0,1,0.2280874,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;390;-345.8241,2272.117;Inherit;False;Uriel_QuintupleColorSelector;-1;;327;31cee3057a501844bbe43a769aec214a;0;11;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;31;COLOR;0,0,0,0;False;30;INT;0;False;29;COLOR;0,0,0,0;False;28;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;983;-779.5801,2756.013;Inherit;False;Property;_WakeUp_Time;WakeUp_Time;56;0;Create;True;0;0;0;False;0;False;3000;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;986;-786.6486,2609.088;Inherit;False;Property;_WakeUp_Blinking;WakeUp_Blinking;57;0;Create;True;0;0;0;False;0;False;3000;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;503;1109.823,-920.0489;Inherit;False;Property;_WakeUp_Alpha;WakeUp_Alpha;42;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1032;958.67,2436.912;Inherit;False;Uriel_Eyes_2_WakeUpBlink;-1;;328;3f559232b69e6004ea00c86a10697d89;0;6;5;COLOR;0,0,0,0;False;26;FLOAT;0;False;10;FLOAT;2;False;16;FLOAT;2;False;15;FLOAT;150;False;14;FLOAT2;0.8,150;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1027;297.4649,2394.063;Inherit;False;Uriel_Eyes_1_QuickOpen;-1;;330;47e9cbd793375844f84e61b71de271c1;0;4;5;COLOR;0,0,0,0;False;16;FLOAT;2;False;7;FLOAT;150;False;9;FLOAT2;0.8,150;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;944;1417.781,2271.703;Inherit;False;Uriel_QuintupleColorSelector;-1;;332;31cee3057a501844bbe43a769aec214a;0;11;11;COLOR;0,0,0,0;False;12;COLOR;0,0,0,0;False;13;INT;0;False;17;COLOR;0,0,0,0;False;16;INT;0;False;20;COLOR;0,0,0,0;False;19;INT;0;False;31;COLOR;0,0,0,0;False;30;INT;0;False;29;COLOR;0,0,0,0;False;28;INT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;31;1915.981,2272.502;Float;False;True;-1;2;ASEMaterialInspector;0;2;PostProcessCamera;c71b220b631b6344493ea3cf87110c93;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;True;7;False;-1;False;True;0;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
...
WireConnection;829;9;793;0
WireConnection;829;10;859;0
WireConnection;863;0;829;0
...
WireConnection;872;1;376;0
WireConnection;872;298;279;0
WireConnection;872;292;292;0
WireConnection;872;179;296;0
WireConnection;872;305;294;0
WireConnection;872;170;295;0
WireConnection;872;39;293;0
WireConnection;872;307;526;0
WireConnection;872;300;885;0
WireConnection;872;301;895;0
WireConnection;688;0;872;0
...
WireConnection;695;41;629;0
WireConnection;695;62;627;0
WireConnection;695;68;628;0
WireConnection;695;11;634;0
WireConnection;695;54;634;1
WireConnection;695;60;635;0
WireConnection;695;69;636;0
WireConnection;695;52;637;0
WireConnection;695;40;637;1
WireConnection;695;6;639;0
WireConnection;695;64;640;0
WireConnection;695;67;641;0
WireConnection;695;25;642;0
WireConnection;695;26;643;0
WireConnection;695;93;644;0
WireConnection;695;28;645;0
WireConnection;695;37;646;0
WireConnection;695;15;887;0
WireConnection;695;55;893;0
WireConnection;673;0;695;61
WireConnection;679;0;695;61
...
WireConnection;1019;4;901;0
WireConnection;1019;40;911;0
WireConnection;1019;41;909;0
WireConnection;1019;39;910;0
WireConnection;1019;6;902;0
WireConnection;1019;44;888;0
WireConnection;1019;42;892;0
WireConnection;882;0;1019;0
WireConnection;876;0;1019;0
...
ASEEND*/
//CHKSM=83BDC8FA922426B082B8C95571EA3334E5BB56ED